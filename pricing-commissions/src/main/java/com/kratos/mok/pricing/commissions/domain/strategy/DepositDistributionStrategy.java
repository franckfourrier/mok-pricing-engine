...
public record DepositDistributionStrategy(List<CommissionShare> keys) implements CommissionStrategy {

    public DepositDistributionStrategy {
    ...
    public CommissionStrategyType type() {
        return CommissionStrategyType.DEPOSIT_DISTRIBUTION;
    }
}
